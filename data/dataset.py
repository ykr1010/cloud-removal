...
class Sen2_MTC_New_Multi(data.Dataset):
    def __init__(self, data_root, mode='train', **kwargs):
...
Sen2_MTC_New_Multi = Sen2_MTC_New_Multi
Sen2_MTC_New1 = Sen2_MTC_New1
Sen2_MTC_New2 = Sen2_MTC_New2
